...
export async function calculateRisk(
  ...
  const s1 = clamp0to20(ipVelocityScore(recentIps, ip)); // Pass array directly
  const s2 = clamp0to20(deviceReuseScore(knownDevices, deviceFingerprint)); // Pass array directly
